...
def main():
    ...
    if dataset_name.startswith("multiwoz") or dataset_name == "sgd":
        ...
        for split in ["train", "dev", "test"]:
            ...
            elif dataset_name == "multiwoz2.0" or dataset_name == "multiwoz2.1":
